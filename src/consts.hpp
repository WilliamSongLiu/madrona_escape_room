...
inline constexpr float buttonWidth = 1.5f;
inline constexpr float lavaWidth = 1.5f;
inline constexpr float cubeWidth = 1.5f;
...
inline constexpr float lavaReward = -0.01f;
